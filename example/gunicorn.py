...
##
# /opt/www/gulliver/.virtualenvs/gulliver/bin/gunicorn --settings DjangoApp/settings --pythonpath /opt/www/gulliver/.virtualenvs/gulliver -c /opt/www/gulliver/gulliver-app/shared/gunicorn_8100.py DjangoApp.wsgi:application
...
django_settings = "DjangoApp.settings"
#pythonpath = "/opt/www/holod/.virtualenvs/holod"
